        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/creations" className="text-gray-300 hover:text-white transition-colors">
                  Créations
                </Link>
              </li>
              <li>
          ...
          {/* Horaires */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-amber-300">Horaires</h3>
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start">
                ...
                <span>Mardi-Samedi<br/>10h30-15h45-17h-19h</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                </svg>
                <span>Dimanche<br/>10h30-14h30</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                </svg>
                <span>Lundi<br/>Fermé</span>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li className="pt-4">
                ...
                <div className="flex space-x-4">
                  <a href="https://www.facebook.com/profile.php?id=61571441440347&rdid=e5rFCiqSFfMpZzdT&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1AufoCRmZH%2F" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/coquelicot.traiteursucre/?igsh=dzA4ZHoxajZrZHYx" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
