    ...
    <>
      ...
      <div className="w-full bg-[#421502] text-white py-1 sm:py-2">
        <div className="container mx-auto px-2 sm:px-3 md:px-4 py-2 sm:py-3 md:py-4">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center space-y-2 sm:space-y-3 md:space-y-0">
            {/* Réseaux sociaux */}
            ...
            {/* Contact */}
            <div className="flex flex-col md:flex-row items-center space-y-1 sm:space-y-2 md:space-y-0 md:space-x-3 sm:md:space-x-4">
              <a href="mailto:coquelicot.traiteursucre@gmail.com" className="flex items-center hover:text-amber-300 transition-colors">
                ...
                <span className="text-xs sm:text-sm">coquelicot.traiteursucre@gmail.com</span>
              </a>
      ...
      <nav className="w-full bg-[#f1e9dc] py-1 sm:py-2 md:py-3 lg:py-4">
        <div className="container mx-auto px-1 sm:px-2 md:px-3 lg:px-4">
          <div className="flex flex-col items-center">
            ...
            {/* Menu pour mobile */}
            <div className="md:hidden w-full flex justify-end mb-1 sm:mb-2 items-center space-x-2 sm:space-x-3 md:space-x-4">
              <button
                onClick={toggleCart}
