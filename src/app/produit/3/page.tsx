...
const productData = {
  ...
  address: '3 rue les prés du roy, Nay',
  images: [
    '/images/la-boite-arevisite.avif',
    '/images/product2.jpg',
    '/images/product3.jpg',
    '/images/product4.jpg',
  ],
  description: [
    'Découvrez la box mensuelle qui réinvente les pâtisseries traditionnelles avec une touche d\'originalité.',
    'Chaque mois, vous pourrez savourer quatre créations uniques qui éveilleront vos papilles.',
    'Laissez-vous séduire par le classique et incontournable 100% noisette',
    'L\'association rafraîchissante des agrumes avec des graines de courge',
    'L\'intense mélange de chocolat noir, café et grué',
    'Le surprenant sésame noir marié à la noix de coco',
    'Cette box est idéale pour les amateurs de nouvelles saveurs en quête d\'aventures gustatives.',
    'Commandez votre coffret et découvrez chaque mois de nouvelles délices qui viendront égayer votre palais !'
  ],
  allergens: [
    '🌰 les fruits à coque',
    '🥛 le lactose',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-lg text-gray-600 mt-1">{productData.subtitle}</p>
