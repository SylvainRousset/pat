    ...
    <>
      ...
      <main className="min-h-screen bg-[#8B6F47] py-4 sm:py-6 md:py-8 lg:py-12">
        <div className="container mx-auto px-2 sm:px-3 md:px-4 max-w-7xl">
          ...
          <div className="mb-10 sm:mb-12 md:mb-16">
            ...
            <div className="bg-[#6B4E31] rounded-xl shadow-xl p-2 sm:p-4 md:p-6 lg:p-10 border-2 border-[#E8A870]/40">
              <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-[#E8A870] mb-4 sm:mb-6 text-center">
                Comment ça marche ?
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 items-center">
                ...
                {/* Texte à droite */}
                <div className="order-1 md:order-2 space-y-3 sm:space-y-4 md:space-y-5 text-[#E8DED0]">
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-[#E8A870] italic text-center mt-4 sm:mt-6 pt-4 sm:pt-6 border-t-2 border-[#E8A870]/30">
          ...
          <div className="bg-[#E8DED0] rounded-xl shadow-xl p-3 sm:p-4 md:p-6 lg:p-10 border-2 border-[#E8A870]/40">
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-center text-[#421500] mb-4 sm:mb-6 md:mb-8">
            ...
            {isLoading ? (
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 lg:gap-8">
                    ...
                    <div className="p-2 sm:p-3 md:p-4 lg:p-6">
                      ...
                      <div className="flex justify-between items-center">
                        <Link
                          ...
                          className="text-[#D9844A] hover:text-[#C27340] font-medium text-xs sm:text-sm underline"
                        >
                          Détails
                        </Link>
                        ...
                        <button
                          ...
                          className="bg-[#D9844A] hover:bg-[#C27340] text-white text-xs px-2 sm:px-3 py-1 sm:py-1.5 rounded-md transition-all duration-300 flex items-center shadow-md hover:shadow-lg"
                        >
      ...
      {isOptionsModalOpen && selectedProduct && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-2 sm:p-4">
          <div className="bg-[#FAF0E6] rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-3 sm:p-4 md:p-6 lg:p-8">
            <div className="flex justify-between items-start mb-4 sm:mb-6">
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-[#421500]">
                {selectedProduct.name}
              </h3>
              <button
                onClick={() => setIsOptionsModalOpen(false)}
                className="text-[#421500] hover:text-[#D9844A] text-2xl sm:text-3xl"
              >
                ×
              </button>
            </div>
            ...
            {selectedProduct.flavors && selectedProduct.flavors.length > 0 && (
              <div className="mb-4 sm:mb-6">
                <h4 className="text-base sm:text-lg font-semibold text-[#421500] mb-2 sm:mb-3">
                  Saveurs disponibles
                </h4>
                <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3">Choisissez UNE saveur :</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {selectedProduct.flavors.map((flavor) => (
                    <label
                      key={flavor}
                      className={`flex items-center p-2 sm:p-3 border-2 rounded-md cursor-pointer transition-all ${
                    ...
                    >
                      <input
                        ...
                        className="h-3 w-3 sm:h-4 sm:w-4 text-[#D9844A] focus:ring-[#D9844A] border-gray-300"
                      />
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3">
                  {selectedProduct.sizes.map((size) => (
                    <label
                      key={size.name}
                      className={`flex flex-col items-center p-2 sm:p-3 md:p-4 border-2 rounded-lg cursor-pointer transition-all ${
                    ...
                    >
                      ...
                      <span className={`text-sm sm:text-base md:text-lg font-bold mt-1 ${
            ...
            <div className="flex gap-2 sm:gap-4">
              <button
                onClick={() => setIsOptionsModalOpen(false)}
                className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-2 sm:py-3 px-3 sm:px-6 rounded-md transition-colors text-sm sm:text-base"
              >
                Annuler
              </button>
              <button
                onClick={confirmAddToCart}
                className="flex-1 bg-[#D9844A] hover:bg-[#C27340] text-white font-bold py-2 sm:py-3 px-3 sm:px-6 rounded-md transition-colors text-sm sm:text-base"
              >
                Ajouter au panier
              </button>
            </div>
      ...
      {zoomedImage && (
        ...
        >
          <div className="relative w-full h-full max-w-6xl max-h-[90vh]">
            <button
              onClick={() => setZoomedImage(null)}
              className="absolute top-2 sm:top-4 right-2 sm:right-4 z-10 bg-[#D9844A] hover:bg-[#C27340] text-white p-2 sm:p-3 rounded-full shadow-lg transition-colors"
              aria-label="Fermer"
            >
